...
import com.example.temanjalan.adapters.TimeAdapter;
import com.example.temanjalan.model.Teman;
import com.example.temanjalan.model.Time;
...
public class BookingActivity extends AppCompatActivity {
    ...
    private String date, idTeman, open, close, text, id;
...
//        mTitle.setText("Booking Friends");
        ...
        btnbook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("IVN", "onError: " + id);
                Log.d("IVN", "onError: " + idTeman);

                System.out.println("Data send : " + id + " " + idTeman + " " + date + " " + json_array.length() + " " + totalPrice);
                AndroidNetworking.post(Constants.BASE_URL + "/api/bookings")
                        .addBodyParameter("user_id", id)
                        .addBodyParameter("teman_id", idTeman)
        ...
        if (date == null) {
            ...
            fetchUnavailableTime(idTeman, date);
        }
